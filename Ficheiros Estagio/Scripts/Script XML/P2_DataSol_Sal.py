import xml.etree.ElementTree as ET # Para manipular arquivos XML
import pyodbc  # Para conectar ao SQL Server
import pandas as pd  # Para manipular os dados em DataFrame
...
def parse_xml_to_dataframe(xml_file):
    """Lê o XML e extrai os dados necessários considerando namespaces."""
...
document_path = "P2_DataSol_Sal_anon.XML"
table_name = "P2_DataSol_Sal"
